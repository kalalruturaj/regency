	...
	<nav class="navbar navbar-custom navbar-transparent navbar-fixed-top" role="navigation">
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">Regency Restaurant</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="custom-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll"><a href="#dishes">Dishes</a></li>
					<li class="page-scroll"><a href="#popular">Popular</a></li>
					<li class="page-scroll"><a href="#services">Services</a></li>
					<li class="page-scroll"><a href="#gallery">Gallery</a></li>
					<li class="page-scroll"><a href="#reservations">Reservations</a></li>
					<li class="dropdown">
	...
	<section id="home" class="intro-module module-image heightfull bg-dark-alfa-30">
		...
		<div class="intro">
			...
			<div class="intro-slider">
				<!-- Slide 1 -->
				<div class="owl-item">
					<h1 class="intro-title">Grand Indian Buffet.</h1>
				</div>
				<!-- Slide 2 -->
				<div class="owl-item">
					<h1 class="intro-title">Authentic Indian Cuisine.</h1>
				</div>
				<!-- Slide 3 -->
				<div class="owl-item">
					<h1 class="intro-title">Impeccable European service.</h1>
				</div>
			</div><!-- .intro-slider -->
			...
			<div class="row">
				<div class="col-sm-6 col-sm-offset-3">
					<div class="module-header">
						<h2 class="module-title">Discover our story</h2>
						<h3 class="module-subtitle">Welcome to Regency Restaurant </h3>
					</div>
				</div>
			</div><!-- .row -->
		...
		<div class="col-sm-6 col-sm-offset-3">
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<h2 class="callout-text">Premium food at affordable price.</h2>
				</div>
			</div><!-- .row -->
				...
				<div class="col-sm-6 col-sm-offset-3">
					<div class="module-header">
						...
						<h3 class="module-subtitle">Our most popular dishes</h3>
                                                <h3 class="module-title">Appetizer</h3>
				...
				<div class="vertical-body">
					<div class="vertical">
						...
						<div class="module-header">
							...
							<h3 class="module-subtitle">see the gallery</h3>
						</div>

						<div class="long-down">
							<p>The European languages are members of family. Their separate existence is a myth. For science, music Europe uses the same vocabulary.</p>
						</div>

						<a href="gallery.html" class="btn btn-custom-1">View Gallery</a>
					...
					<div class="col-sm-4">
						<div class="gallery-item">
							<figure class="overlay">
								...
								<figcaption>
									<a href="assets/images/gallery-1.jpg" class="gallery" title="Title 1"></a>
									<div class="caption-inner">
										<div class="overlay-icon">
											<span class="icon-magnifier"></span>
										</div>
					...
					<div class="col-sm-4">
						<div class="gallery-item">
							<figure class="overlay">
								...
								<figcaption>
									<a href="assets/images/gallery-2.jpg" class="gallery" title="Title 2"></a>
									<div class="caption-inner">
										<div class="overlay-icon">
											<span class="icon-magnifier"></span>
										</div>
					...
					<div class="col-sm-4">
						<div class="gallery-item">
							<figure class="overlay">
								...
								<figcaption>
									<a href="assets/images/gallery-3.jpg" class="gallery" title="Title 3"></a>
									<div class="caption-inner">
										<div class="overlay-icon">
											<span class="icon-magnifier"></span>
										</div>
					...
					<div class="col-sm-4">
						<div class="gallery-item">
							<figure class="overlay">
								...
								<figcaption>
									<a href="assets/images/gallery-4.jpg" class="gallery" title="Title 4"></a>
									<div class="caption-inner">
										<div class="overlay-icon">
											<span class="icon-magnifier"></span>
										</div>
					...
					<div class="col-sm-4">
						<div class="gallery-item">
							<figure class="overlay">
								...
								<figcaption>
									<a href="assets/images/gallery-5.jpg" class="gallery" title="Title 5"></a>
									<div class="caption-inner">
										<div class="overlay-icon">
											<span class="icon-magnifier"></span>
										</div>
					...
					<div class="col-sm-4">
						<div class="gallery-item">
							<figure class="overlay">
								...
								<figcaption>
									<a href="assets/images/gallery-6.jpg" class="gallery" title="Title 6"></a>
									<div class="caption-inner">
										<div class="overlay-icon">
											<span class="icon-magnifier"></span>
										</div>
